...
base_path = "/Users/michaelkokorudz/Documents/Qhacks/data"  # Update this to your Qhacks directory path
...
if "raw_content" or "title" in old_english_df.columns:
...
pie_df.rename(
    columns={
        ...
        "englihs_translation": "english_translation",
